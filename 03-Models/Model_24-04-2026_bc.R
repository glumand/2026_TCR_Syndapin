...
waterfall <- plotValues(outframe[1:200], tol=0.01)
print(waterfall)
...
plotProfilesAndPaths(profiles, whichpars = c("TCR_Endo_CTRL", "TCR_Golgi_1", "TCR_Golgi_1_CTRL", "TCR_Golgi_2_CTRL", "TCR_Golgi_2"))
