...
# Paste function call
cluster_result <- try({
    mstrust(objfun = obj, center = ini, studyname = "multistart", rinit = 0.1, rmax = 8, iterlim = 5000, sd = 3, parupper = parub, parlower = parlb, fits = 1, cores = 16, fixed = NULL, cautiousMode = T)
})
